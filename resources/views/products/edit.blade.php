                    ...
                    <div class="col-span-2">
                        <div>
                            ...
                            <x-input @keyup="convertToSlug()" id="productName" class="block mt-1 w-full text-smalt-700"
                                type="text" name="product_name" autocomplete="off"
                        ...
                        <div class="mt-3">
                            ...
                            <x-textarea name="description" class="mt-1 h-48 w-full text-smalt-700 resize-none"
                                id="description" :value="old('description') ?? $product->description" required>
                            </x-textarea>
                        </div>
                    </div>
                    ...
                    <div class="col-span-1">
                        <div>
                            ...
                            <x-select id="category" class="block mt-1 w-full text-smalt-700" name="category"
                                ...
                                <option value="{{ $category }}" {{ ((old('category') ?? $product->category) ==
                                    $category) ?
                                    'selected' :'' }}>
                                    {{ $category }}
                                </option>
                        ...
                        <div class="mt-3 relative">
                            ...
                            <x-input onkeypress="return isDecimalInput(this, event);" id="productPrice"
                                ...
                                :value="old('product_price') ?? $product->product_price" placeholder="0.00" required
                                autofocus />
                        ...
                        <div class="mt-2">
                            ...
                            <div class="flex items-center">
                                <x-input id="quantity" autocomplete="off"
                                    ...
                                    name="quantity" :value="old('quantity') ?? $product->quantity" placeholder="0"
                                    required autofocus />
                                <div class="order-3">
