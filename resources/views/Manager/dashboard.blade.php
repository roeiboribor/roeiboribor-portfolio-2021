<x-app-layout>
    <x-slot name="header">
        <div
            ...
            <h1 class="text-3xl font-bold">Manager's Dashboard</h1>
        </div>
    </x-slot>

    <div class="container flex items-center justify-center pt-8 animate__animated animate__bounceInDown">
        <div class="dashboard-card w-7/12">
            <h1 class="text-center font-extrabold text-5xl">Welcome to your dashboard!</h1>
        </div>
    </div>
