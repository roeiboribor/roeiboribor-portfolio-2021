    ...
    <div class="card relative px-4 pt-8 pb-8 h-full w-full z-10">
        ...
        <div class="card-body">
            ...
            <div class="flex justify-center gap-4 md:gap-8 lg:gap-4 py-8 text-center">
                ...
                <a class="social-btn" href="https://www.linkedin.com/in/roei-boribor/" target="_blank">
                    <i class='bx bxl-linkedin-square text-4xl transition duration-300 hover:opacity-70'></i>
                </a>
                <a class="social-btn" href="https://www.facebook.com/roeiharris/" target="_blank">
                    <i class='bx bxl-facebook-square text-4xl transition duration-300 hover:opacity-70'></i>
                </a>
                <a class="social-btn" href="mailto:roeiboribor@gmail.com" target="_blank">
                    <i class='bx bxs-envelope text-4xl transition duration-300 hover:opacity-70'></i>
                </a>
            </div>
            <div class="line-dotted mx-8 my-2"></div>
            <div class="pt-8">
