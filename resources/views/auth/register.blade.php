    ...
    <x-auth-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div>
                ...
                <x-input id="first_name" class="block mt-1 w-full text-smalt-700" type="text" name="first_name"
                    :value="old('first_name')" placeholder="Enter First Name" required autofocus />
            </div>
            <div class="mt-4">
                <x-label for="last_name" :value="__('Last Name')" />

                <x-input id="last_name" class="block mt-1 w-full text-smalt-700" type="text" name="last_name"
            ...
            <div class="mt-4">
                ...
                <x-input id="password_confirmation" class="block mt-1 w-full text-smalt-700" type="password"
